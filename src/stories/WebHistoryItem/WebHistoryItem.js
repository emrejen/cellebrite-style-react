...
import './WebHistoryItem.css';

export const WebHistoryItem = ({ url, date }) => {
  ...
  return (
    <div className="web-history-item-container" onMouseOver={show} onMouseLeave={hide}>
      <div className="web-history-item-icon">
        <svg width="20px" height="20px" viewBox="0 0 256 257" version="1.1">
          <defs>
      ...
      <div className="web-history-item-meta">
        <div className="same-row browse-meta">
          <div className="web-history-item-title">Browse</div>
          {visible ? (
            <div>
              <FontAwesomeIcon icon={faTag} />
              <FontAwesomeIcon icon={faStickyNote} style={{ paddingLeft: '10px' }} />
            </div>
          ) : null}
        </div>
        <div className="same-row browse-meta">
          <div className="web-history-item-url">{url}</div>
          <div className="web-history-item-date">{date}</div>
        </div>
      </div>
    </div>
  );
